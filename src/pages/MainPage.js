      ...
      <Jumbotron>
        ...
        <p>
          ...
          <ul>
            ...
            <li>
              A list of students that have access to clubhouses (night / day
              keys etc..)
            </li>
            <li>
              An event calendar to look for events (Available also as iCal /
              RSS)
            </li>
            ...
            <li>
              A comprehensive admin interface for administrators to be
              constantly up to date of whats happening.
            </li>
            <li>
              A very flexible permissions system. You can add roles and
              customize their permissions as you wish.
            </li>
          </ul>
        </p>
        <hr />
